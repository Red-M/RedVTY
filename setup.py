...
with open('redvty/__init__.py', 'r') as fh:
    reg = re.compile(r"^VERSION.+?\'(.*)\'$",re.DOTALL|re.MULTILINE)
    redvty_version = reg.findall(fh.read())[0]
...
setuptools.setup(
    name='redvty',
    version=redvty_version,
    url='https://bitbucket.org/Red_M/RedSSH',
    license='GPLv2',
    author='Red_M',
    author_email='redvty_pypi@red-m.net',
    description='VTY automation via SSH.',
